...
class _ReportScreenState extends State<ReportScreen> {
  ...
  void _navigateToDetailedReport(String reportTitle) {
    Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) => DetailedReportScreen(
                ...
                child: Center(
                  child: Text.rich(
                    TextSpan(
                      children: [
                        TextSpan(
                          text: title == 'Incident' ? '↑' : title == 'Away time' ? '↓' : percentage[0],
                          style: TextStyle(
                            fontSize: 14,
                        ...
                        TextSpan(
                          text: title == 'Incident' ? '12%' : percentage.substring(1),
                          style: TextStyle(
                            fontSize: 14,
